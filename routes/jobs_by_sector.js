module.exports = function(app, pg, conString) {
    ...
    app.get('/jobs', function(req, res) {
        ...
        var yeardomain = ["2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025"];
        ...
        if (!req.query.sector) {
            ...
            var sectordomain = ["1", "2", "3", "10", "11", "21", "22", "23", "31-33", "42", "44-45", "48-49", "51", "52", "53", "54", "55", "56", "61", "62", "71", "72", "81", "99"];
...
app.get('/jobs0', function(req, res) {
        ...
        //create array of years
        var year = (req.query.year).split(",");
        var yeardomain = ["2020", "2021", "2022", "2023", "2024"];
        if (!validate(year, yeardomain)) {
            res.send('one of your year inputs is not valid!');
            return;
        }
