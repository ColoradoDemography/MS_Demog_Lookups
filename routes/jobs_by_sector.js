module.exports = function(app, pg, conString) {
    ...
    app.get('/jobs', function(req, res) {
        ...
        var yeardomain = ["2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022"];
...
app.get('/jobs0', function(req, res) {
    ...
    app.get('/jobsbase', function(req, res) {
        ...
        if (!req.query.sector) {
            ...
            var sector = (req.query.sector).split(",");
            var sectordomain = ["0", "1000", "2000", "3000", "4000", "5000", "6000", "7000", "8000", "9000", "10000", "11000", "12000", "13000", "14000", "15000", "16000", "17000", "18000", "19000", "20000", "21000", "22000", "23000", "24000", "25000", "26000", "27000", "28000", "29000"];
            if (!validate(sector, sectordomain)) {
                res.send('one of your sector inputs is not valid!');
                return;
            }
