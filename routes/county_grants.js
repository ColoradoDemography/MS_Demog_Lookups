module.exports = function(app, pg, conString) {
    ...
    app.get('/county_grants', function(req, res) {
        ...
        var basequery = "SELECT countyfips,county,grant1,grant2,grant3,grant4 from estimates.county_grants where " + yearstring + " GROUP By countyfips, county, ORDER BY countyfips";
        ...
        //put it all together
            ...
            sqlstring = basequery + "(" + countystring + ") AND " + "(" + yearstring + ") AND " + groupby + ";";
            break;
