...
module.exports = function(app, pg, conString) {
    ...
    app.get('/bea_jobs', function(req, res) {
          ...
          if(req.query.all === 'yes'){
            sendtodatabase("SELECT * from estimates.bea_jobs;", pg, conString, res);
          }else{
       

        //get valid counties
        var p1 = new Promise(function(resolve, reject) {
            request('https://gis.dola.colorado.gov/lookups/bea_jobs_county', function(error, response, body) {
        ...
        function main(valid_areas) {
           ...
           //     res.send('your county/region input is not valid!');
            ...
            var countystring = construct_delimited_string(padcounty, 'estimates.bea_jobs', 'fips');
